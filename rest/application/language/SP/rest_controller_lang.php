...
$lang['qlana_account_created'] = 'CKMT Account is Created';
$lang['hello'] = 'Hello';
$lang['welcome_to_qlana'] = 'Welcome to CKMT!!!';
$lang['login_details_are'] = 'Access application with following details:';
$lang['email_label'] = 'Email';
$lang['password_label'] = 'Password';
$lang['account_created_label'] = 'CKMT Account is Created';
...
$lang['covenant_notification_subject'] = 'CKMT | New Covenant | {title}';

//user registration
$lang['user_registration_subject'] = 'CKMT | Login Information';
$lang['user_registration_mail'] = '<p>Dear <i>{first_name} {last_name}</i>, Welcome to EADB - Credit Knowledge Management tool, Click <a href="{login_url}">here</a> to login with following details.<p>Email: {email} <br> Password: {password}<br> <b>Note: It is recommended to update your Password and Security Question when you login for the first time.</b> </p>';

//forget password
$lang['forget_password_subject'] = 'CKMT | Password Recovery';
...
$lang['workflow_mail_subject'] = 'CKMT | Review request | {project_title} Project';
...
$lang['workflow_form_comments_subject'] = 'CKMT | Request for Information {project_title} Project ';
...
$lang['meeting_subject'] = 'CKMT | New Meeting {title}({module_type}) on {date_time} at {location}';
$lang['meeting_subject_modified'] = 'CKMT | Updated Meeting {title}({module_type}) on {date_time} at {location}';
$lang['meeting_subject_cancelled'] = 'CKMT | Cancelled Meeting {title}({module_type}) on {date_time} at {location}';
...
$lang['task_subject'] = 'CKMT | New Task | {task_title} ';
$lang['LR'] = ' | ';
...
$lang['task_subject_modified'] = 'CKMT | Updated Task | {task_title} ';
...
$lang['mail_footer'] = '<p style="color:#8e8e8e;font-size:10px">If you are not sure what this is about, you can disregard this message. Have questions? Need help?
                <a href="mailto:itadmin@eadb.org" style="color:#74a6f9; text-decoration:none">Contact our support team </a> and we’ll get back to you in just a few minutes - promise</p>';
